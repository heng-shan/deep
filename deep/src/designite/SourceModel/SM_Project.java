...
public class SM_Project extends SM_SourceItem {
	...
	private void createPackageObjects() {
		...
		for (CompilationUnit unit : compilationUnitList) {
			...
			//System.out.print(pkgObj+"\n");
		}
		//System.out.print("pkg:    "+compilationUnitList+"\n");
	}
	...
	private void createCompilationUnits() {
		try {
			...
			for (String file : sourceFileList) {
				...
				//System.out.print("unitname:   "+unitName+"\n");
	...
	public void parse() {
		...
		parseAllPackages();
		//System.out.println(compilationUnitList);
	}

	public void resolve() {
		Logger.log("Resolving symbols...");
		for (SM_Package pkg : packageList) {
			//System.out.print("pkg:   "+pkg+"\n");
			pkg.resolve();
		}
		hierarchyGraph.computeConnectedComponents();
		dependencyGraph.computeStronglyConnectedComponents();
		//System.out.print("depen:    "+hierarchyGraph.getStronglyConnectedComponents()+"\n");
		
		//System.out.println("depend:   "+dependencyGraph.getStrongComponentOfVertex(dependencyGraph.getStronglyConnectedComponents().get(4).get(0))+"\n");
		//DIRECTED
	}
